#https://github.com/tech-srl/lstar_extraction/blob/master/Training_Functions.py
from Helper_Functions import n_words_of_length

def make_train_set_for_target(target,alphabet,lengths=None,max_train_samples_per_length=300,search_size_per_length=1000,
